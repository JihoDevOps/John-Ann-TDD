...
// Product Instances
const productId = "6154101c39a8ac6cfa27a883"
...
describe("Product Controller Update", () => {
  ...
  it("should call productModel.findByIdAndUpdate", async () => {
    ...
    expect(productModel.findByIdAndUpdate).toHaveBeenCalledWith(
      productId,
      updatedProduct,
      { new: true } // retrun 시 update 된 인스턴스를 받도록 설정(default: false)
    );
  });
...
describe("Product Controller Delete", () => {
  ...
  it("should return 200 response", async () => {
    let deletedProduct = { name: "deleted product", description: "it is deleted" };
  ...
  it("should handle 404 when item does't exist", async () => {
